...
export type LeadOptions = {
  countries: LeadOption[]
  degrees: LeadOption[]
  courses: LeadOption[]
  intakes: LeadOption[]
  studyPurposes: LeadOption[]
  qualifications: LeadOption[]
  englishTests: LeadOption[]
  englishTestStatuses: LeadOption[]
  budgets: LeadOption[]
  fundingSources: LeadOption[]
  financialReadiness: LeadOption[]
  decisionTimelines: LeadOption[]
  decisionMakers: LeadOption[]
  applicationReadiness: LeadOption[]
  studyIntents: LeadOption[]
  visaTypes: LeadOption[]
  contactMethods: LeadOption[]
  contactTimes: LeadOption[]
  sources: LeadOption[]
  statuses: LeadOption[]
  countryTeams: Array<{ countryId: string; countryName: string; team: NamedRef }>
}
...
export type LeadRecord = {
  ...
  preferredCountry: LeadOption | null
  preferredDegree: LeadOption | null
  preferredCourse: LeadOption | null
  preferredCourseText: string | null
  preferredIntake: LeadOption | null
  studyPurpose: LeadOption | null
  studyPurposeOther: string | null
  highestQualification: LeadOption | null
  institutionName: string | null
  passingYear: number | null
  resultCgpa: string | null
  studyGapMonths: number | null
  englishTest: LeadOption | null
  englishTestStatus: LeadOption | null
  englishOverallScore: number | null
  englishTestDate: string | null
  estimatedBudget: LeadOption | null
  fundingSource: LeadOption | null
  financialReadiness: LeadOption | null
  previouslyAppliedAbroad: boolean | null
  previousVisaApplication: boolean | null
  previousVisaRefusal: boolean | null
  visaApplication: {
    previousCountry: LeadOption | null
    visaType: LeadOption | null
    applicationYear: number | null
    applicationResult: string | null
  } | null
  visaRefusal: {
    refusalCountry: LeadOption | null
    refusalYear: number | null
    refusalReason: string | null
  } | null
  decisionTimeline: LeadOption | null
  decisionMaker: LeadOption | null
  applicationReadiness: LeadOption | null
  studyIntent: LeadOption | null
  preferredContactMethod: LeadOption | null
  preferredContactTime: LeadOption | null
  preferredContactAt: string | null
  source: LeadOption | null
  campaignText: string | null
  assignedTeam: NamedRef | null
...
export type GlobalSearchHit = {
  id: string
  type: 'page' | 'user' | 'employee' | 'lead' | 'role' | 'master-data' | 'activity' | 'audit'
  title: string
  subtitle?: string
  href: string
  group: string
